...
class MediaWrapper: AudioPlayerDelegate {
    ...
    /**
    * remove check queue.last.
    * I do not why they did that
    * it happen when you you move position the last item
    * the track player will be stop
    * backup: else if id == queue.last?.id { actionAfterRemovals = "stop" }
    */
